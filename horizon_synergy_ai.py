...
class HorizonSynergyAI():
    def __init__(self, pinecone_api_key: str, openai_api_key: str, gpt_model: str = "gpt-3.5-turbo"):
        self.pinecone = PineconeClient(api_key=pinecone_api_key)
        self.gpt = GPTClient(api_key=openai_api_key, model_name=gpt_model)

    def search_and_compare(self, project_description: str, top_k: int = 5) -> list[SynergyResult]:
        results = []
